...
public class AdminNewOrdersActivity extends AppCompatActivity {
        ...
        FirebaseRecyclerAdapter<AdminOrders,AdminOrdersViewHolder> adapter=
               new FirebaseRecyclerAdapter<AdminOrders, AdminOrdersViewHolder>(options) {
                   ...
                   protected void onBindViewHolder(@NonNull AdminOrdersViewHolder adminOrdersViewHolder, final int i, @NonNull final AdminOrders adminOrders) {
                       ...
                       adminOrdersViewHolder.userTotalPrice.setText("Toatal Amount: "+adminOrders.getTotalAmount());
                       adminOrdersViewHolder.userDateTime.setText("Ordered at: "+adminOrders.getDate());
                       adminOrdersViewHolder.userAdress.setText("Adress: "+adminOrders.getAdress()+ " , " +adminOrders.getCity());
                        ...
                        adminOrdersViewHolder.showOrdersButton.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                Intent intent=new Intent(getApplicationContext(),AdminUserProducts.class);
                        ...
                        adminOrdersViewHolder.itemView.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                builder.setTitle("Are you sure to  REMOVE the order?");
    ...
    public static class AdminOrdersViewHolder extends RecyclerView.ViewHolder
    {
        ...
        public AdminOrdersViewHolder(@NonNull View itemView) {
            ...
            userTotalPrice=itemView.findViewById(R.id.oredr_total_price);
            userDateTime=itemView.findViewById(R.id.order_date_time);
            userAdress=itemView.findViewById(R.id.oredr_adress_city);
