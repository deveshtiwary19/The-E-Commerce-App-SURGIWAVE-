...
public class SettingsActivity extends AppCompatActivity {
    ...
    private void updateOnlyUserInfo()
    {
        ...
        {
            Toast.makeText(this, "Please provide Contact number to help delivery", Toast.LENGTH_SHORT).show();
        }
       else {
            ...
            ref.child(Prevelant.currentOnlineUser.getPhone()).updateChildren(userMap);
    ...
    private void userInfoSaved()
    {
        ...
        {
            Toast.makeText(this, "Please provide Adress for Delivery", Toast.LENGTH_SHORT).show();
        }
        else if (TextUtils.isEmpty(userPhoneEditText.getText().toString()))
        {
            Toast.makeText(this, "Please Provide Contact Number To  help Delivery", Toast.LENGTH_SHORT).show();
    ...
    {
        DatabaseReference UsersRef = FirebaseDatabase.getInstance().getReference().child("Users").child(Prevelant.currentOnlineUser.getPhone());
